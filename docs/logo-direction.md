...
| `mmh-logo-v5-favicon.svg` | 小尺寸优化：减少细节，适合 favicon | favicon、App 小图标 |
| `mmh-logo-v6-pine-clay.svg` | 非黑金方案：松针绿 + 象牙白 + 陶土色 | 更家庭、更耐看 |
| `mmh-logo-v7-teal-mist.svg` | 非黑金方案：深青蓝 + 珍珠白 + 浅水绿 | 更清爽、更现代 |
| `mmh-logo-v8-terracotta-ink.svg` | 非黑金方案：暖陶土 + 亚麻白 + 墨色 | 更温暖、更生活化 |
| `mmh-logo-v9-ribbon-m.svg` | 新字形：单线带状 M | 更轻、更现代 |
| `mmh-logo-v10-monument-m.svg` | 新字形：厚重碑刻 M | 更稳、更品牌化 |
| `mmh-logo-v11-arch-m.svg` | 新字形：柔和拱形 M | 更亲和、更家用 |
| `mmh-logo-v12-script-m.svg` | 草体方向：半草体 M | 更有书写感 |
| `mmh-logo-v13-signature-m.svg` | 草体方向：签名感 M | 更高级、更个性 |
| `mmh-logo-v14-calligraphic-m.svg` | 草体方向：书法感 M | 更有节奏感 |
