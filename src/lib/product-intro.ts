...
export const PRODUCT_INTROS: Record<DisplayLanguage, ProductIntro> = {
  "zh-CN": {
    ...
    mantra: "哦嘛呢嘛呢吽",
    lead: "一个把家庭财务安放好的本地优先智能系统。",
    paragraphs: [
      "MoneyMoneyHome 是面向家庭和个人的本地优先智能财务管理系统，以本地数据安全存储为基础，把日常记账、账户资产、信用卡账单、基金定投、保险保单、房贷还款、往来款和邮箱账单识别串成一套可以长期维护的家庭财务工作台。",
      "它不只是记录一笔账，而是尽量把复杂流程自动化：信用卡保留交易日、入账日和账单期；房贷自动计算本金、利息、余额和利率调整后的还款计划；基金定投按周期自动执行并关联持仓；保险产品和保单可生成缴费计划与相关记录；邮箱账单可通过 AI 识别导入为标准记账数据。",
      "系统支持 Web、移动端、计划任务、AI 识别流程和开放 API 等多种入口，让同一套家庭财务数据在不同界面之间保持统一、准确、可追溯。",
    ],
    highlights: ["信用卡账单周期管理", "基金定投自动执行", "保险产品与缴费计划", "邮箱账单 AI 识别导入", "本地数据安全存储", "多界面统一接入"],
  },
  "en-US": {
