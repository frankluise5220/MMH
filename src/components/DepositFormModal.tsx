    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/35 p-4">
      <div className="w-full max-w-md rounded-xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        ...
        <form className="p-4 space-y-3 overflow-y-auto max-h-[80vh]" onSubmit={onSubmit}>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              <div className="text-xs font-medium text-slate-600">年化利率（%）</div>
          ...
          <div className="space-y-1">
            <div className="text-xs font-medium text-slate-600">最低金额</div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1">
              <div className="text-xs font-medium text-slate-600">{isRedeem ? "取出账户" : "存入账户"}</div>
