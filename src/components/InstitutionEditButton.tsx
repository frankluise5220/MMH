...
type InstitutionType = "bank" | "brokerage" | "payment" | "ewallet" | "other";
const TYPE_LABELS: Record<InstitutionType, string> = {
  bank: "银行", brokerage: "证券", payment: "三方支付", ewallet: "钱包", other: "其他",
};
...
export function InstitutionEditButton({
  ...
  return (
    <>
      <button
        type="button"
        onClick={() => { setName(institution.name); setType((institution.type as InstitutionType) ?? "other"); setOpen(true); }}
