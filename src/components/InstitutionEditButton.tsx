...
type InstitutionType = "bank" | "brokerage" | "payment" | "ewallet" | "debt" | "other";
const TYPE_LABELS: Record<InstitutionType, string> = {
  bank: "银行", brokerage: "证券", payment: "三方支付", ewallet: "钱包", debt: "债权债务", other: "其他",
};
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/35 p-4">
          <div className="w-full max-w-sm rounded-xl bg-white border border-slate-200 shadow-lg overflow-hidden">
            <div className="px-4 py-3 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
              <div className="text-sm font-semibold text-slate-800">编辑往来机构/人员</div>
            ...
            <form className="p-4 space-y-3" onSubmit={onSubmit}>
              <div className="space-y-1">
                <div className="text-xs font-medium text-slate-600">往来机构/人员名称</div>
                <input
                  value={name}
