...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({ ok: true, sessionDays, fundUnitsDecimals, aiPanelEnabled, timeZoneMode, timeZone });
}
...
export async function PUT(req: NextRequest) {
  ...
  const response = NextResponse.json({ ok: true, sessionDays, fundUnitsDecimals, aiPanelEnabled, timeZoneMode, timeZone });
